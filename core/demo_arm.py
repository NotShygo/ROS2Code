...
if __name__ == "__main__":
    ...
    arm = RoboticArm2(
        ...
        end_effector_link="panda_link8",   # "panda_hand_tcp" or "panda_link8"
        joint_names=[                         # << explicit, prevents the 9-joint bug
    ...
    gripper = Gripper2(
        backend="moveit",
        group_name="hand",                    # try "panda_hand" if "hand" is rejected
